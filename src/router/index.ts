      ...
      children: [
        ...
        { path: 'events/new', name: 'events-new', component: () => import('../views/forms/EventWizard.vue') },
        {
          ...
          children: [
            ...
            { path: 'guests/:guestId/edit', name: 'event-guests-edit', component: () => import('../views/forms/GuestsForm.vue') },
            ...
            { path: 'categories/:categoryId/edit', name: 'event-categories-edit', component: () => import('../views/forms/CategoriesForm.vue') },
            ...
            { path: 'invitations/send', name: 'event-invitations-send', component: () => import('../views/event/SendInvitationsView.vue') },
        ...
        { path: 'events/:id/edit', name: 'event-edit', component: () => import('../views/forms/EventEditForm.vue') },
