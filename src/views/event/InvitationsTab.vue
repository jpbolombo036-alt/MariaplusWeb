      ...
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          <PermGuard :allow="['INVITATION_SEND']">
            <button class="h-10 px-5 rounded-lg bg-[#25D366] text-white text-[13px] font-semibold inline-flex items-center gap-2 shadow-lg shadow-[#25D366]/30 hover:brightness-95 transition-all" @click="$router.push(`/dashboard/events/${id}/invitations/send`)">
