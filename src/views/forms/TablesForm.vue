  ...
  <div class="min-h-full">
    <div class="max-w-3xl mx-auto">
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 class="text-[22px] font-bold text-slate-900 tracking-tight">Nouvelle table</h1>
          <p class="text-[13px] text-slate-500 mt-0.5 font-medium">Créez une table et définissez sa capacité.</p>
        </div>
      </div>
